      ...
      const shadow = this.scene.getElementById('shadow');
			...
			}
			{
				...
				}
				{
					...
					{
						const shadow_1_1_0 = this.scene.createElement(xrFrameSystem.XRMesh,{
							'geometry':`plane`,
							'rotation':`-90 0 0`,
							'scale':`1 1 1`,
							'uniforms':`u_baseColorFactor:0 1 0 0.5`,
							'states':`alphaMode:BLEND`,
						});
						shadow_1_1.addChild(shadow_1_1_0);
					}
					{
						const shadow_1_1_1 = this.scene.createElement(xrFrameSystem.XRMesh,{
							'node-id':`mesh-x`,
							'position':`1 0 0`,
							'scale':`2 0.02 0.02`,
							'geometry':`cube`,
					...
					{
						const shadow_1_1_2 = this.scene.createElement(xrFrameSystem.XRMesh,{
							'node-id':`mesh-y`,
							'position':`0 1 0`,
							'scale':`0.02 2 0.02`,
							'geometry':`cube`,
					...
					{
						const shadow_1_1_3 = this.scene.createElement(xrFrameSystem.XRMesh,{
							'node-id':`mesh-z`,
							'position':`0 0 1`,
							'scale':`0.02 0.02 2`,
							'geometry':`cube`,
