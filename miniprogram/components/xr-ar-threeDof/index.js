    ...
    handleReady({detail}) {
      ...
      const shadow = this.scene.getElementById('shadow');
			...
			}
			{
				...
				{
					const shadow_1_0 = this.scene.createElement(xrFrameSystem.XRGLTF,{
						'model':`gltf-item`,
						'position':`1 0 1`,
				...
				{
					const shadow_1_6 = this.scene.createElement(xrFrameSystem.XRMesh,{
						'node-id':`mesh-z`,
						'position':`0 0 1`,
						'scale':`0.02 0.02 2`,
						'geometry':`cube`,
				...
				{
					const shadow_1_7 = this.scene.createElement(xrFrameSystem.XRCamera,{
						'id':`camera`,
						'node-id':`camera`,
