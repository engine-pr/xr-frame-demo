      ...
      const shadow = this.scene.getElementById('shadow');
			{
				...
				shadow.addChild(shadow_0);
				{
					const shadow_0_0 = this.scene.createElement(xrFrameSystem.XRAssetLoad,{
						'type':`atlas`,
						'asset-id':`portal-atlas`,
						'src':`https://mmbizwxaminiprogram-1258344707.cos.ap-guangzhou.myqcloud.com/xr-frame/demo/particles/portal.json`,
					});
